...
def run_quality_gates(
    ...
    """
    gates = [
        ("pytest", [sys.executable, "-m", "pytest", "-v", "tests/unit/test_dataset_validation.py", "tests/unit/test_proposal_validation.py", "tests/unit/test_validation_pipeline.py", "tests/unit/test_evolution_ledger.py", "tests/unit/test_post_evaluator_and_metrics.py"]),
